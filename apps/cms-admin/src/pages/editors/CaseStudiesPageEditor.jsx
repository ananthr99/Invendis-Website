...
export default function CaseStudiesPageEditor() {
	...
	async function handleSave() {
		...
		try {
			...
			await savePageContent({ token, contentPath: CONTENT_PATH, before: original, after: saveForm, page: "Case Studies", userEmail });
			setOriginal(saveForm);
			setForm(saveForm);
			setDirty(false);
			toast("Case Studies page saved — live in a few seconds", "ok");
		} catch (err) {
	...
	const ActiveEditor = CASE_STUDIES_SECTION_EDITORS[activeTab];
